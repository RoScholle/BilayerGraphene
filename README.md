This is code related to the paper "Unrestricted Hartree-Fock analysis of the Hubbard model on single-layer graphene and Bernal bilayer graphene", doi: https://link.aps.org/doi/10.1103/drn2-4s3q
...
If you want to recreate the phase diagrams, you can also click through the jupyter notebook. The generated data of BBG for U = 3t is already preprocessed and ready to be plotted.
